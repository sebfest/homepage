# Generated by Django 2.2.5 on 2021-03-25 11:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_viewed', models.DateTimeField(blank=True, editable=False, help_text='Last viewed', null=True)),
                ('notebook_file', models.FileField(blank=True, help_text='A notebook file', upload_to='uploads/%Y/%m/%d/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['ipynb'])])),
